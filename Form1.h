...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// mnuOptions
			// 
			this->mnuOptions->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(12) {this->mnuClearSettings, 
				this->toolStripSeparator1, this->mnuDarkMode, this->toolStripSeparator2, this->mnuMaxResults, this->mnuAllowBadSkills, this->mnuAllowPiercings, this->mnuAllowEventArmor, this->mnuAllowJapaneseOnlyDLC, 
